...
| --- | --- | --- |
| mGBA | planned adapter | Strong candidate for first live adapter. Existing local Lua script already reads Gen 3 party/opponent data. |
| VBA-RR | planned adapter | Has Lua support and can draw overlays directly. Good fallback for classic Lua overlays. |
