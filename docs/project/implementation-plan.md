...
| `P04` | Event Routing And Actions | active - `P04-T001`, `P04-T002`, and `P04-T003` completed; `P04-T004` is in review |
...
- [`P04-T004`](../tasks/P04/P04-T004.md) — Restore browser app-shell module resolution by keeping Node-only event validation out of the browser domain descriptor. In review.
